            ...
            <div class="backend-domains__card">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="backend-domain-table__actions">
                                                ...
                                                <a href="{{ route('backend.domain.dns-records', $domain->domain_name) }}" class="backend-domain-table__action backend-domain-table__action--primary">
                                                    DNS записи
                                                </a>

                                                 <a href="{{ route('backend.domain.nameservers', $domain->domain_name) }}" class="backend-domain-table__action backend-domain-table__action--primary">
                                                     Nameservers
                                                </a>
                ...
                @else
                    ...
                    <div class="backend-domains__empty">
                        ...
                        <p>Регистрирайте нов домейн и той ще се появи тук заедно със статуса, срока на регистрация и настройките за подновяване.</p>
