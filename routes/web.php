...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/domains')->group(function () {
        ...
        Route::get('/nameservers/{domain}', [BackendDomainController::class, 'nameServers'])->name('backend.domain.nameservers');
        Route::get('/dns-records/{domain}', [BackendDomainController::class, 'dnsRecords'])->name('backend.domain.dns-records');
